angular.module('Jyap.service-admob', [])
		...
		if(_admob){
			...
			if(ionic.Platform.isAndroid()) {
				_admobid = { // for Android
				    banner: 'ca-app-pub-8818301262480718/4993055017',
				    interstitial: 'ca-app-pub-8818301262480718/7329242618'
				};
			}

		   	if(ionic.Platform.isIOS()){
		    	_admobid = { // for iOS
		    	    banner: 'ca-app-pub-8818301262480718/1282709014',
		    	    interstitial: 'ca-app-pub-8818301262480718/7534392217'
		    	};
		   	}
